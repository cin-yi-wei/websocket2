...
var a= message.filter(function(v){ return old.indexOf(v) > -1 })  //交集
var b = message.filter(function(v){ return a.indexOf(v) == -1 })  // b=message-a  差集
/*
...
*/
   for(var len in b){
     $("#user").append('<button type="button"   id="div' + b[len]+ '" value="'+b[len]+'">'+b[len]+'</button>');
