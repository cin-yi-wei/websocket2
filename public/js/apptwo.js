...
},{"base64-js":5,"ieee754":29,"isarray":9}],9:[function(require,module,exports){
...
},{"./transport":15,"./transports/index":16,"component-emitter":11,"debug":22,"engine.io-parser":24,"indexof":30,"parseqs":33,"parseuri":34}],15:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":12,"debug":22,"engine.io-parser":24,"parseqs":33,"xmlhttprequest-ssl":21,"yeast":49}],20:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":12,"debug":22,"engine.io-parser":24,"parseqs":33,"ws":7,"yeast":49}],21:[function(require,module,exports){
(function (global){
...
},{"./on":38,"./socket":39,"backo2":3,"component-bind":10,"component-emitter":11,"debug":41,"engine.io-client":13,"indexof":30,"socket.io-parser":44}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":10,"component-emitter":11,"debug":41,"has-binary2":27,"parseqs":33,"socket.io-parser":44,"to-array":48}],40:[function(require,module,exports){
(function (global){
...
},{"./binary":43,"./is-buffer":45,"component-emitter":11,"debug":46,"isarray":31}],45:[function(require,module,exports){
(function (global){
...
notification.on('usertoken', function (message) {
  ...
  var a_name = message.filter(function (v) {
    return old_name.indexOf(v) > -1;
  }); //交集
  var b_name = message.filter(function (v) {
    return a_name.indexOf(v) == -1;
  }); // b=message-a  差集
  ...
  var c_name = old_name.filter(function (v) {
    return a_name.indexOf(v) == -1;
  }); // c=old-a 差集
...
function myFunction(clicked_id) {
  ...
  alert("mytoken=" + TOKEN + "token=" + document.getElementById(clicked_id).value);
}
